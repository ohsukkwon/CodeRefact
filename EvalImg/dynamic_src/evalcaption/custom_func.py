...
from GlobalVars import ERR_CODE_NONE, ARG_KEY_NAME_PROMPTTYPE
...
class ClsGenerateOutputImpl(ClsAbsGenerateOutput):
    def __init__(self, arg_args, arg_my_log):
        ...
        self.mMyName = f'(impl:{self.__class__.__name__})'
        self.mArgs = arg_args
...
class CustomEngineImpl(AbstractApiEngine):
    ...
    def do_eval(self, slicedArrSentences):
        ...
        return ERR_CODE_NONE, self._make_dummy_table(slicedArrSentences), TokenRecord(0, 0, 0, 0,0)
